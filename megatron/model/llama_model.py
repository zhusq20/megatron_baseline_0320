...
class LlamaLMHead(MegatronModule):
    ...
    def __init__(self,
        ...
        super(LlamaLMHead, self).__init__(config=config)
...
class LlamaEmbedding(MegatronModule):
    ...
    def __init__(self,
                 ...
                 init_method,
                 config):
        super(LlamaEmbedding, self).__init__(config=config)
...
class LlamaParallelMLP(MegatronModule):
    ...
    def __init__(self, config, init_method, output_layer_init_method):
        super(LlamaParallelMLP, self).__init__(config=config)
        # self.config = config
...
class LlamaParallelAttention(MegatronModule):
    ...
    def __init__(self, config,
        ...
        # self.config = config
        # print("LlamaParallelAttention config", self.config == None)
    ...
    def forward(self, hidden_states, attention_mask, inference_params=None):
        ...
        if not self.use_flash_attn:
            ...
            with tensor_parallel.get_cuda_rng_tracker().fork():
                context_layer = self.core_attention(q, k, v)
...
class LlamaParallelTransformer(MegatronModule):
    ...
    def __init__(self, config,
        ...
        # self.config = config
        # print("LlamaParallelTransformer config", self.config == None)
        assert self_attn_mask_type == AttnMaskType.causal
