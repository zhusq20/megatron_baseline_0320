...
def core_transformer_config_from_hf_config(args):
    ...
    kw_args['layernorm_zero_centered_gamma'] = True
    kw_args['layernorm_epsilon'] = 1e-5
    kw_args['deallocate_pipeline_outputs'] = False
    kw_args['pipeline_dtype'] = torch.float16
    kw_args['batch_p2p_comm'] = False
    kw_args['num_moe_experts'] = 1
    kw_args['rotary_interleaved'] = False

    kw_args['hidden_size'] = args.hidden_size
    kw_args['num_attention_heads'] = args.num_attention_heads
    kw_args['num_layers'] = args.num_hidden_layers
    kw_args['ffn_hidden_size'] = args.intermediate_size
